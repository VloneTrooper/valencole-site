...
**The Board is not independent of the Minister.** Of the Board's members, only three are nominated by bodies outside government — the Association of Road Contractors, the Ghana Institution of Engineering, and the Ghana Institution of Surveyors. The road user and the civil society representative are both nominated by the Minister. Quorum is eight and the chairperson holds a casting vote.[^12] Decisively, section 12 provides that the Minister may give written policy directives on matters of policy and that the Board **shall comply**. The Minister also determines which activities constitute each maintenance category (s.30(2)), sets the allocation formula weights (s.32(2)), must authorise any regional re-allocation in writing (s.32(7)), designates emergency works that bypass the Annual Maintenance Plan (s.33), and approves the arrears payment schedule (s.57(3)).
...
The toll base was also removed and has only recently returned. Road tolls were abolished in the 2022 Budget Statement, presented November 2021, on the argument that congestion costs exceeded revenue forgone.[^21] Tolls had been contributing roughly GH¢78m annually.[^22] In 2026 Parliament approved a twenty-year public-private partnership to reintroduce automated tolling, with 70% of gross toll revenue to Government and 30% to the operator.[^23]

*A minor note on collection.* The Ministry of Finance has recorded shortfalls between amounts collected and amounts lodged, arising partly from a 9% retention by the Ghana Revenue Authority under the GRA Act — which the Ministry itself describes as conflicting with ESLA's requirement that all collections be lodged, and recommends resolving by amendment. The Road Fund Levy shortfall was 16.8% in 2016 but total ESLA lodgment shortfall had fallen to about 2.5% by 2019.[^24] The leakage is real, lawful, and no longer material at scale.

### 2.3 Two pots: what the appropriation actually funds

Road spending flows through two parallel channels, not one. The Ministry's appropriation and the Fund's allocation are additive: the 2025 estimates state that the total approved budget ceiling **excluding the Road Fund** is GH¢3,244,979,700, and the 2024 tables list the ministry total and the Road Fund as separate rows that sum to the sector grand total.[^25]
...
Note that the Minister determines by Gazette which activities fall in each category,[^27] so the boundaries are movable by ministerial act.

### 2.4 The fund pays for the past

**Pot two — the Fund.** In 2024 the Road Fund received approximately GH¢4.8bn. Of the GH¢4.90bn applied:[^28]
...
1. Construction commitments are made on a multi-year basis at a pace unconstrained by maintenance cash flow. The Big Push programme covers more than 2,000 km across sixteen regions, with close to GH¢50bn in multi-year commitments approved.[^31] An investigation using Right to Information requests alleged 81 sole-sourced contracts worth over GH¢73bn awarded within seven months.[^32] Sole-sourcing removes the friction — advertisement, evaluation, review — that ordinarily paces commitment against cash.
...
3. Contractors are entitled to interest on delayed payment, so arrears compound. The Auditor-General's road performance audits record delayed payments contributing to cost overruns through fluctuations and interest.[^33]
...
6. Roads deteriorate past the point where routine work is effective. A 66 km reconstructed stretch of the Tarkwa–Agona Nkwanta road, built at a cost of €95m, showed significant deterioration in under two years.[^34]
7. Rehabilitation is a construction expense. Return to step one.

The scale is acknowledged. The Minister stated in 2025 that government owed road contractors approximately GH¢25bn with outstanding commitments exceeding GH¢100bn, and that some Interim Payment Certificates had been unpaid since 2018.[^35]

**Who waits longest is the finding.** At the Board's inauguration the Minister flagged the position of small and medium contractors, many of whom have not been paid since 2019, despite handling roadside weeding, drain clearing and pothole repairs.[^36] That is the statutory definition of routine maintenance. The contractors performing the cheapest and most preventive work in the system are the ones seven years in arrears.
...
The Act already contains the distinction. Section 30(1) classifies maintenance into four categories; section 55 defines rehabilitation as restoring roads that have already deteriorated, expressly excluding routine and periodic work. Section 31(1) then pools all four into a single ninety per cent floor.
...
The structural fix is commitment control: no road contract awarded unless the multi-year liability it creates is registered against a forward provision. Section 39 already requires the Fund to interface with the Ghana Integrated Financial Management Information System, which manages commitments against appropriation, so the mechanism exists in outline. Designing it would require access to commitment data that is not publicly available, and this memo does not attempt it.
...
**Corroborating record.** The World Bank's implementation completion report notes that in 1999 the Road Fund account at the Bank of Ghana was virtually frozen, with annual disbursement collapsing.[^45] A related project delivered approximately 84% of its appraised road length, largely because of delays of up to seven years between appraisal and execution.[^46] The same reports record that periodic maintenance works were to be undertaken mainly by local contractors while heavier rehabilitation was packaged for international competitive bidding — the contracting model this memo recommends scaling.
...
[^12]: Act 1147, ss.4(1), 8(3), 8(5), 12.

[^13]: Kwame Governs Agbodza, Minister for Roads and Highways, remarks at the inauguration of the RMTF Board of Trustees, 9 December 2025, reported in "Road maintenance fund board inaugurated," Graphic Online, 11 December 2025. https://www.graphic.com.gh/news/general-news/ghana-news-road-maintenance-fund-board-inaugurated.html
...
[^26]: Act 1147, ss.30(1), 55.

[^27]: Act 1147, s.30(2).

[^28]: MoRH, *2025 PBB Estimates*, §6 Expenditure Trends and Financial Performance for 2024. The current-year figure is derived: GH¢1,192,715,344 approved less GH¢448,825,900 loan repayment.

[^29]: Ibid., Sub-Programme Results Statements SP3.1 and SP3.2.
...
[^36]: Agbodza, remarks at the inauguration of the RMTF Board of Trustees, 9 December 2025, as reported in Graphic Online, 11 December 2025 (see note 13).

[^37]: Agbodza, remarks during the President's inspection of the Navrongo–Chuchuliga–Tumu road, reported in "Gov't disburses GH¢23.1bn to clear road contractors' arrears – Roads Minister," MyJoyOnline, August 2026. https://www.myjoyonline.com/govt-disburses-gh%C2%A223-1bn-to-clear-road-contractors-arrears-roads-minister/
